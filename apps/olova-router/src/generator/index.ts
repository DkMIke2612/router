...
"import { createLink, OlovaRouter, useRouter, useParams, useSearchParams, usePathname, Outlet, clientOnly, useLoaderData, useActionData, usePending, useIsLoading, useIsSubmitting, useLoaderError, useSubmit } from 'olova-router/router';\n" +
allImports + "\n\n" +
"export const routes = [\n" +
(routeObjects || '') + "\n" +
"];\n\n" +
...
"export { OlovaRouter, useRouter, useParams, useSearchParams, usePathname, Outlet, clientOnly, useLoaderData, useActionData, usePending, useIsLoading, useIsSubmitting, useLoaderError, useSubmit };\n" +
"export type { NotFoundPageConfig, SearchParams, SetSearchParamsOptions, LayoutRoute, Metadata, RouteDefinition, LoaderContext, ActionContext, ClientOnlyOptions } from 'olova-router/router';\n";
}
